...
$navLinks       = [];
$reportData     = $service->getLocationReport($filters);
...
if ($exportFormat) {
    ...
    ReportExporter::export(
        ...
        array_merge($filters, ['report' => 'location_reports'])
    );
}
...
$pageTitle        = 'Location Movement Reports';
$pageDescription  = 'Visualize the flow of inventory across warehouses, storage areas, and branches over time.';
$pageEyebrow      = 'Inventory Intelligence';
$tableTitle       = 'Inventory Location Dataset';
$tableSubtitle    = 'Current & historical assignment records';
$tableColumns     = $reportData['columns'];
$tableRows        = $reportData['rows'];
$perPage          = $filters['per_page'];
$emptyState       = 'No location movements found for your selected filters.';
